...
class RoomVoiceRecorderLocalDataSource @Inject constructor(
    ...
    override val voiceRecordingsFlow: Flow<List<VoiceRecorder>>
        get() = voiceRecorderDao.getAllVoiceRecordings().map {
    ...
    override suspend fun deleteAllVoiceRecorders() = withContext(dispatcherIO) {
